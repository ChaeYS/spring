...
<html lang="ko">
    <head>
		...
		<link rel="icon" type="image/png" sizes="32x32" href="/assetsfavicon-32x32.png">
		<link rel="icon" type="image/png" sizes="96x96" href="assets/favicon-96x96.png">
		<link rel="icon" type="image/png" sizes="16x16" href="/assetsfavicon-16x16.png">
        ...
        function fileCheck() {
        	...
        	//Swal.fire("댓글의 길이가 짧습니다", "댓글은 10자 이상이어야 합니다", "warning");
        }
        </script>
    </head>
    <body id="page-top">
            ...
            <div class="container">
               <div class="text-center">
               		...
               		<div class="input-group mb-3">
               			...
               			<input type="text" name="gtitle" class="form-control" id="basic-url" aria-describedly="basic-addon3">
               		</div>
